...
from app.routes import demo_data_routes, ed_routes, projects_routes, home_routes, dfd_routes, pdp_routes, pgr_routes, etp_routes, tr_routes
...
app.include_router(ed_routes.router)