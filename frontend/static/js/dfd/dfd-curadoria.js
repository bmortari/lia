...
( ) Não`;
    ...
    const createItemRow = (item = {}) => {
        ...
        descriptionInput.className = 'flex-grow p-2 border-gray-300 border rounded-md item-description focus:ring-primary focus:border-primary';

        const quantityInput = document.createElement('input');
        quantityInput.type = 'number';
        quantityInput.value = item.quantidade || '';
        quantityInput.placeholder = 'Qtd.';
        quantityInput.className = 'w-24 p-2 border-gray-300 border rounded-md item-quantity focus:ring-primary focus:border-primary';
        quantityInput.min = '1';
